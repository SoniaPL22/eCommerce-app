        ...
        return (
            <div>
                ...
                <div className='home-page-wrapper'>
                    ...
                    <h2 className='home-page-description'>Aquí encontrarás fofuchas, amigurumis y muchas manualidades más</h2>
                    <div className='offers-wrapper'>
                        <div className='two-offers-wrapper'>
                            ...
                            <div className='offer offer-two'>
                                <h2 className='offer-text'>¡¡Lote de <span className='offer-detail'>tres amigurumis</span> a elegir por tan sólo <span className='offer-detail'>20 €</span>!!</h2>
                            </div>
                        </div>
